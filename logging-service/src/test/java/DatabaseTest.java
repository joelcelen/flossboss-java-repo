...
public class DatabaseTest {
    ...
    public void before(){
        ...
        Document item = new Document()
                .append("service_name", "LoggingService_Test")
                .append("version", 1)
                .append("status", "testing")
                .append("available", false);
        dbClient.createItem(item);
        this.itemID = dbClient.getID("LoggingService_Test");
    }
    ...
    public void updateItem(){
        ...
        String result = dbClient.readItem(this.itemID);
        String expected = String.format("{\"_id\": {\"$oid\": \"%s\"}, \"service_name\": \"LoggingService_Updated\", \"version\": 1, \"status\": \"testing\", \"available\": false}", this.itemID);
        assertEquals(expected, result);
